import HeroBackgroud from "@/images/about-bg.jpg";
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-4xl py-32 sm:py-48 lg:py-24">
            <div className="text-center">
              ...
              >
                Founded in 2019, Humancloud has evolved from a full-stack
                product engineering company into a global leader in{" "}
                <b>AI-first engineering</b> — building secure, scalable, and
                production-ready AI systems for enterprises across the world.
              </p>
