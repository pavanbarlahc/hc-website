...
import TestimonialImg01 from "@/images/logos/testimonial-01.jpg";
import TestimonialImg02 from "@/images/logos/testimonial-02.jpg";
import TestimonialImg03 from "@/images/logos/testimonial-03.jpg";
import TestimonialImg04 from "@/images/logos/testimonial-04.jpg";
    ...
    <section className="relative before:pointer-events-none before:absolute before:inset-0 before:-z-10 before:h-[120%] before:bg-linear-to-b before:from-gray-100">
      <div className="pt-12 md:pt-20">
        ...
        <div className="relative mx-auto flex max-w-[94rem] justify-center">
          ...
          {/* Row */}
          <div className="group inline-flex w-full flex-nowrap overflow-hidden py-12 [mask-image:_linear-gradient(to_right,transparent_0,_black_10%,_black_90%,transparent_100%)] md:py-20">
